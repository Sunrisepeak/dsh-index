package = {
    ...
    dsh = {
        ...
        versions = {
            ["0.3.5"] = { commit = "735c212b136e3fb3f9769e1f07266cd091570a55" },
            ["0.3.3"] = { commit = "f4ef59fb31439225abefe45d6e793235a2a9d5e0" },
            ["0.3.1"] = { commit = "31a556aca4a5ebc572e3b1fcd7addbe8d589ea08" },
